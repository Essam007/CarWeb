...
<div class="container">
    <div class="row">
        ...
        <div class="col-4">
            <h3>{{__('message.Car Name')}}:{{$car->name}}</h3>

            <div><h3>{{__('message.Car Model')}}:{{$car->model}}</h3></div>

            <div><h3>{{__('message.Car Price')}}:{{$car->price}}</h3></div>

            <div><h3>{{__('message.Car Details')}}:{{$car->details}}</h3></div>
            <div>
